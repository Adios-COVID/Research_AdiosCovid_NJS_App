        ...
        <div class="container" className={styles.container}>
            <div class="row" className={styles.row}>
                ...
                <ul class="terms" className={styles.terms}>
                    ...
                    <li>
                    Compliance: The Long COVID data in this repository is for research and informational purposes only, and should not be used for diagnostic or treatment purposes. Any use of the data for clinical purposes must comply with relevant regulatory requirements, such as HIPAA or GDPR.
                    </li>
                </ul>
